const posts = [
  {
    ...
    featuredImage: require('@/assets/discover_word/thumb/ds_1.jpg'),
    author: 'Jessie Wang',
  ...
  },
  {
    ...
    desc:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry scrambled it to make text of the printing and typesetting industry scrambled a type specimen book text of the dummy text of the printing printing and typesetting industry scrambled dummy text of the printing.',
    featuredImage: require('@/assets/discover_word/thumb/ds_2.jpg'),
    author: 'Li Love',
    createdAt: new Date().toLocaleDateString()
  },
  {
    ...
    desc:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry scrambled it to make text of the printing and typesetting industry scrambled a type specimen book text of the dummy text of the printing printing and typesetting industry scrambled dummy text of the printing.',
    featuredImage: require('@/assets/discover_word/thumb/ds_3.jpg'),
    author: 'Jim Wang',
    createdAt: new Date().toLocaleDateString()
  },
  {
    ...
    desc:
      'Lorem Ipsum is simply dummy text of the printing and typesetting industry scrambled it to make text of the printing and typesetting industry scrambled a type specimen book text of the dummy text of the printing printing and typesetting industry scrambled dummy text of the printing.',
    featuredImage: require('@/assets/discover_word/thumb/ds_4.jpg'),
    author: 'John Doe',
    createdAt: new Date().toLocaleDateString()
  }
]
